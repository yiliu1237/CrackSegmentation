...
def load_state_dict(torch_module, state_dict, strict=False, logger=None):
    ...
    Args:
        torch_module (Module): Module that receives the state_dict.
    ...
    """
    unexpected_keys = []
    own_state = torch_module.state_dict()
